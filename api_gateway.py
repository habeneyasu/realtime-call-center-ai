...
from models import AudioChunkRequest, ControlMessage, StatusResponse, WebSocketMessage, ErrorResponse
...
async def http_exception_handler(request, exc: HTTPException):
    ...
    return JSONResponse(
        ...
        content=ErrorResponse(
            ...
            message=exc.detail or f"An error occurred: {exc.status_code}",
...
async def general_exception_handler(request, exc: Exception):
    ...
    return JSONResponse(
        ...
        content=ErrorResponse(
            ...
            details={"type": type(exc).__name__} if os.getenv("ENVIRONMENT") == "development" else None
        ).model_dump()
    )
